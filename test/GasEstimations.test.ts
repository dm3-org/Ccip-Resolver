...
describe("Gas Estimations", () => {
    ...
    describe("BedrockProofVerifier", () => {
        it("Deployment", async () => {
            ...
            console.log(
                "Based on 60 GWEI it would've cost : " + ethers.utils.formatEther(gasUsed.mul(ethers.utils.parseUnits("60", "gwei")))
            );
            console.log(
                "Based on 70 GWEI it would've cost : " + ethers.utils.formatEther(gasUsed.mul(ethers.utils.parseUnits("70", "gwei")))
            );
            console.log(
                "Based on 80 GWEI it would've cost : " + ethers.utils.formatEther(gasUsed.mul(ethers.utils.parseUnits("80", "gwei")))
            );
            console.log(
                "Based on 90 GWEI it would've cost : " + ethers.utils.formatEther(gasUsed.mul(ethers.utils.parseUnits("90", "gwei")))
            );
            console.log(
                "Based on 100 GWEI it would've cost : " + ethers.utils.formatEther(gasUsed.mul(ethers.utils.parseUnits("100", "gwei")))
            );
        });
        it("Deployment", async () => {
